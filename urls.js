...
var mongoServer = process.env.MongoServer || '127.0.0.1'
var mongoPort = process.env.MongoPort || 27017;
var mongoUsername = process.env.MongoUserName || 'admin';
var mongoPassword = process.env.MongoPassword;  // No fallback, since null is fine for local instance
